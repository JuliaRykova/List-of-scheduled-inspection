...
// подключаем файл в котором храниться подключение к бд
...
<head>
    ...
    <!-- подключение bootstrap , стилей и скриптов -->
...
<body>
    ...
    <div class="container-fluid">
        <div class="table-responsive">
            <!-- создание таблицы -->
            <!-- Атрибут data-filter-control="true" указывает на то, что элемент управления фильтра данных является активным и может быть использован для фильтрации данных. -->
            <table class="table table-info table-striped table-hover  table-bordered " id="myTable" data-filter-control="true">
                ...
                ?>
                    ...
                    <tr class="row table-flex">
                        ...
                        <!-- переход для редактирования на другую страницу -->
